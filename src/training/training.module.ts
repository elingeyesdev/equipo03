...
@Module({
  imports: [TypeOrmModule.forFeature([UserTraining, UserTrainingGoals, UserTrainingPreferences, UserTrainingRestriction, EmergencyContact, WorkoutSession, WorkoutSet])],
