...
export class ActivitiesController {
  ...
  @Post(':id/schedules') @UseGuards(JwtAuthGuard) @ApiBearerAuth('access-token')
  @ApiOperation({ summary: 'Crear horario de actividad' })
  @ApiBody({ type: CreateActivityScheduleDto })
  createSchedule(@Param('id', ParseIntPipe) id: number, @Body() body: CreateActivityScheduleDto) { return this.svc.createSchedule({ ...body, gymActivityId: id }); }
