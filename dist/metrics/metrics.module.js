...
const metrics_controller_1 = require("./infrastructure/metrics.controller");
let MetricsModule = class MetricsModule {
};
exports.MetricsModule = MetricsModule;
exports.MetricsModule = MetricsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([physical_metrics_history_entity_1.PhysicalMetricsHistory])],
