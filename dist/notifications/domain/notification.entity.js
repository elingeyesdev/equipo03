...
__decorate([
    (0, typeorm_1.Column)({ type: 'integer', name: 'template_id', nullable: true }),
    __metadata("design:type", Number)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => notification_template_entity_1.NotificationTemplate, { nullable: true, onDelete: 'SET NULL' }),
